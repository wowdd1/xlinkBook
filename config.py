...
class Config():
    ...
    website_icons = {'.pdf' : 'http://icons.iconarchive.com/icons/iynque/flat-ios7-style-documents/256/pdf-icon.png',\
                 ...
                 'similar2' : 'https://metaphor.systems/images/favicon.ico',\
                 'chatgpt' : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkUzmvqRyoOdmKbjPdwo8wPa9btEE5EgE8ng&usqp=CAU',\

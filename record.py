...
class Record():
    ...
    def record_to_text_desc_list(self, utils, tagList, accountTagList):
        textList = []
        descList = []
        ...
        while True:
            ...
            if end > 0:
                ...
                itemDesc = item[item.find(':') + 1 :] 
                
                if utils.isAccountTag(resourceType, accountTagList):
                    textList.append(resourceType)
                    descList.append(item)
                else:
                    itemFields = itemDesc.split(',')
...
class Tag():
    def __init__(self):
        ...
        self.tag_modelscope = 'modelscope:'
        self.tag_colab = 'colab:'
        ...
        self.tag_ossinsight = 'ossinsight:'
        self.tag_oschina = 'oschina:'
        self.tag_gitee = 'gitee:'
        self.tag_libhunt = 'libhunt:'
        ...
        self.tag_y_course = 'y-course:'
        self.tag_y_podcast = 'y-podcast:'
        self.tag_y_post = 'y-post:'
        ...
        self.tag_dribbble = 'dribbble:'
        self.tag_shadertoy = 'shadertoy:'
        self.tag_tumblr = 'tumblr:'
        self.tag_inoreader = 'inoreader:'
        self.tag_commonlounge = 'commonlounge:'
        self.tag_woboq = 'woboq:'
        ...
        self.tag_list = [self.tag_id, self.tag_title, self.tag_url, self.tag_videourl, self.tag_author, self.tag_winner, self.tag_ratings, self.tag_term,\
                         ...
                         self.tag_meetup, self.tag_huodongxing, self.tag_y_video, self.tag_y_channel, self.tag_y_channel2, self.tag_y_playlist, self.tag_y_stream, self.tag_y_course, self.tag_y_podcast, self.tag_y_post, self.tag_rutube, self.tag_r_playlist, self.tag_r_video, self.tag_pornhub, self.tag_randomstreetview, self.tag_topwebsiterank, self.tag_topwebsiterank_keyword, self.tag_topwebsiterank_category, self.tag_award, self.tag_website, self.tag_url, self.tag_memkite, \
        ...
        self.tag_list_account = {self.tag_slack :  'https://%s.slack.com/',\
                        ...
                        self.tag_modelscope : 'https://modelscope.cn/models/%s',\
                        self.tag_colab : 'https://colab.research.google.com/%s',\
                        ...
                        self.tag_oschina : 'https://www.oschina.net/%s',\
                        self.tag_gitee : 'https://gitee.com/%s',\
                        self.tag_libhunt : 'https://www.libhunt.com/%s',\
                        ...
                        self.tag_y_course : 'https://www.youtube.com/%s/courses',\
                        self.tag_y_podcast : 'https://www.youtube.com/%s/podcasts',\
                        self.tag_y_post : 'https://www.youtube.com/%s/posts',\
                        ...
                        self.tag_dribbble : 'https://dribbble.com/%s',\
                        self.tag_shadertoy : 'https://www.shadertoy.com/user/%s',\
                        self.tag_tumblr : 'http://%s.tumblr.com/',\
                        self.tag_inoreader : 'https://www.inoreader.com/folder/%s',\
                        self.tag_commonlounge : 'https://www.commonlounge.com/community/%s',\

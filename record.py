...
class Tag():
    def __init__(self):
        ...
        self.tag_list = [self.tag_id, self.tag_title, self.tag_url, self.tag_videourl, self.tag_author, self.tag_winner, self.tag_ratings, self.tag_term,\
                         ...
                         self.tag_meetup, self.tag_huodongxing, self.tag_y_video, self.tag_y_channel, self.tag_y_channel2, self.tag_y_playlist, self.tag_y_stream, self.tag_rutube, self.tag_r_playlist, self.tag_r_video, self.tag_pornhub, self.tag_randomstreetview, self.tag_award, self.tag_website, self.tag_url, self.tag_memkite, \

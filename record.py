...
class Tag():
    def __init__(self):
        ...
        self.tag_list = [self.tag_id, self.tag_title, self.tag_url, self.tag_videourl, self.tag_author, self.tag_winner, self.tag_ratings, self.tag_term,\
                         ...
                         self.tag_youtube, self.tag_github, self.tag_github_explore, self.tag_gitlab, self.tag_gitee, self.tag_sourcegraph, self.tag_vimeo, self.tag_g_group, self.tag_g_plus, self.tag_medium, self.tag_goodreads, self.tag_fb_group, self.tag_fb_pages, \
                         ...
                         self.tag_keybase, self.tag_telegram, self.tag_iptv_zone, self.tag_tagboard, self.tag_band, self.tag_pscp, self.tag_searchin, self.tag_command, self.tag_class, self.tag_trello, self.tag_rocket, self.tag_crx]
        ...
        self.tag_list_account = {self.tag_slack :  'https://%s.slack.com/',\
                        ...
                        self.tag_crx : 'https://robwu.nl/crxviewer/?crx=https://chrome.google.com/webstore/detail/%s',\
